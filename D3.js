...
switch (starWarsCharacters.eye_color) {
  ...
  case "red":
    ...
    break;
  case "blue-gray":
    eyeColor.blue_gray.push(starWarsCharacters.name);
    break;
  default:
    // Handle any other eye colors or cases here if needed
    break;
}
...
let crewMass = 0;
while (crewMass < starWarsCharacters.lenght) {
  crewMass = starWarsCharacters.length.mass + 1;
...
for (let i = 0; i < starWarsCharacters.length; i++) {
  if (starWarsCharacters[i].gender === "n/a") {
    genderRobot.push(starWarsCharacters[i].name);
  }
}
console.log("genderRobot", genderRobot);
/* --EXTRA-- ESERCIZIO 9
